...
const PICKUP_EN = 'Between 7:30 and 8:00 PM (Downtown, Recoleta, Puerto Madero, San Telmo, Constitución and Palermo)';
...
const HOUSES: House[] = [
  {
    ...
    address_es: 'Barracas, Buenos Aires',
    address_en: 'Barracas, Buenos Aires',
    ...
    options: [
      {
        ...
        pickup_window_es: PICKUP_ES,
        pickup_window_en: PICKUP_EN,
      ...
      },
      {
        ...
        available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: null,
        pickup_window_en: null,
        dinner_time_es: null,
        dinner_time_en: null,
        show_time_es: 'Show desde 22:00',
        show_time_en: 'Show from 10:00 PM',
    ...
    options: [
      {
        ...
        price_adult_usd: 140, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00 (zona céntrica y Palermo)', pickup_window_en: 'Between 7:30 and 8:00 PM (downtown and Palermo)',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 106, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 96, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 56, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:30 y 21:00 (zona céntrica) / 19:30 a 20:00 (Palermo)', pickup_window_en: 'Between 8:30 and 9:00 PM (downtown) / 7:30 to 8:00 PM (Palermo)',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 38, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:30 y 21:00', pickup_window_en: 'Between 8:30 and 9:00 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
    ],
  },
  ...
  // ── La Ventana ─────────────────────────────────────────────
  {
    ...
    address_es: 'San Telmo, Buenos Aires',
    address_en: 'San Telmo, Buenos Aires',
    schedule_summary_es: 'Lunes a Domingos. Traslado 19:30–20:00. Cena desde 20:00. Show desde 22:00.',
    schedule_summary_en: 'Monday to Sunday. Transfer 7:30–8:00 PM. Dinner from 8:00 PM. Show from 10:00 PM.',
    options: [
      {
        ...
        price_adult_usd: 180, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00 (Palermo desde 19:00)', pickup_window_en: 'Between 7:30 and 8:00 PM (Palermo from 7:00 PM)',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        code: 'cena-show-ejecutiva', name_es: 'Cena Show Ejecutiva', name_en: 'Dinner Show Executive',
        ...
        price_adult_usd: 120, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00 (Palermo desde 19:00)', pickup_window_en: 'Between 7:30 and 8:00 PM (Palermo from 7:00 PM)',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 120, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 21:00 y 21:30 (Palermo 20:45)', pickup_window_en: 'Between 9:00 and 9:30 PM (Palermo 8:45 PM)',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 70, price_child_usd: null, has_dinner: false, has_transfer: false, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: null, pickup_window_en: null,
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
    ],
  },
  ...
  // ── Madero Tango ───────────────────────────────────────────
  {
    ...
    address_es: 'Puerto Madero, Buenos Aires',
    address_en: 'Puerto Madero, Buenos Aires',
    ...
    options: [
      {
        ...
        price_adult_usd: 222, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:40)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:40 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        code: 'cena-show-vip', name_es: 'Cena Show VIP', name_en: 'Dinner Show VIP',
        description_es: null, description_en: null,
        ...
        price_adult_usd: 154, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:40)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:40 PM)',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 116, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:40)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:40 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
      ...
      },
      {
        ...
        price_adult_usd: 39, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:40)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:40 PM)',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
    ],
  ...
  // ── Homero Manzi ───────────────────────────────────────────
  {
    ...
    address_es: 'Esquina de San Juan y Boedo, Buenos Aires',
    address_en: 'Corner of San Juan and Boedo, Buenos Aires',
    schedule_summary_es: 'Lunes a Domingos. Traslado 20:00–20:30. Cena desde 20:30. Show desde 22:00.',
    schedule_summary_en: 'Monday to Sunday. Transfer 8:00–8:30 PM. Dinner from 8:30 PM. Show from 10:00 PM.',
    options: [
      {
        ...
        price_adult_usd: 104, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30', pickup_window_en: 'Between 8:00 and 8:30 PM',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
    ...
    options: [
      {
        ...
        price_adult_usd: 220, price_child_usd: 110, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 21:45', show_time_en: 'Show from 9:45 PM',
      },
      {
        code: 'cena-show-ejecutiva', name_es: 'Cena Show Ejecutiva', name_en: 'Dinner Show Executive',
        description_es: null, description_en: null,
        ...
        price_adult_usd: 180, price_child_usd: 90, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 21:45', show_time_en: 'Show from 9:45 PM',
      },
      {
        ...
        price_adult_usd: 130, price_child_usd: 65, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 21:45', show_time_en: 'Show from 9:45 PM',
      },
      {
        ...
        price_adult_usd: 150, price_child_usd: 75, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:45 y 21:15', pickup_window_en: 'Between 8:45 and 9:15 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 21:45', show_time_en: 'Show from 9:45 PM',
      },
      {
        ...
        price_adult_usd: 90, price_child_usd: 45, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:45 y 21:15', pickup_window_en: 'Between 8:45 and 9:15 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 21:45', show_time_en: 'Show from 9:45 PM',
      },
    ],
  ...
  // ── El Aljibe ──────────────────────────────────────────────
  {
    ...
    address_es: 'Buenos Aires',
    address_en: 'Buenos Aires',
    ...
    options: [
      {
        ...
        price_adult_usd: 130, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 18:30 y 19:00', pickup_window_en: 'Between 6:30 and 7:00 PM',
        dinner_time_es: 'Cena desde 19:00', dinner_time_en: 'Dinner from 7:00 PM', show_time_es: 'Show desde 20:00', show_time_en: 'Show from 8:00 PM',
      },
      {
        code: 'solo-show', name_es: 'Solo Show', name_en: 'Show Only',
        description_es: null, description_en: null,
        ...
        price_adult_usd: 100, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 20:00', show_time_en: 'Show from 8:00 PM',
      },
    ],
  },
    ...
    options: [
      {
        ...
        price_adult_usd: 200, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:45)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:45 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 150, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:45)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:45 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
      ...
      },
      {
        ...
        price_adult_usd: 100, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 21:00 y 21:30 (Palermo 19:45)', pickup_window_en: 'Between 9:00 and 9:30 PM (Palermo 7:45 PM)',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
    ],
  },
  ...
  // ── Piazzolla Tango ────────────────────────────────────────
  {
    ...
    address_es: 'Galería Güemes, Buenos Aires',
    address_en: 'Galería Güemes, Buenos Aires',
    ...
    options: [
      {
        ...
        price_adult_usd: 200, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:00 y 19:45 (Palermo desde 18:45)', pickup_window_en: 'Between 7:00 and 7:45 PM (Palermo from 6:45 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:15', show_time_en: 'Show from 10:15 PM',
      },
      {
        code: 'cena-show-ejecutiva', name_es: 'Cena Show Ejecutiva', name_en: 'Dinner Show Executive',
        description_es: null, description_en: null,
      ...
      },
      {
        ...
        includes_es: ['Mesa individual', 'Cena de 3 pasos: entrada, plato principal y postre a elección (opciones vegetariana, celíaca y vegana)', 'Bebidas libres: vino Tribu Malbec o Chardonnay Bodega Trivento, cervezas, gaseosas o agua mineral', 'Infusiones: café, cortado, lágrima o té', 'Show de tango', 'Traslado ida y vuelta desde y hacia el hotel'],
        includes_en: ['Individual table', '3-course dinner: starter, main course and dessert of choice (vegetarian, gluten-free and vegan options)', 'Free drinks: Tribu Malbec or Chardonnay wine by Bodega Trivento, beers, soft drinks or mineral water', 'Hot drinks: coffee, cortado, lágrima or tea', 'Tango show', 'Round-trip transfer to and from the hotel'],
        price_adult_usd: 100, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:00 y 19:45 (Palermo desde 18:45)', pickup_window_en: 'Between 7:00 and 7:45 PM (Palermo from 6:45 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
      ...
      },
      {
        ...
        includes_es: ['Mesa privada (palco con la mejor vista al escenario)', 'Entrada o postre, 2 bebidas a elección, agua o gaseosa, copa de vino o cerveza', 'Show de tango', 'Traslado ida y vuelta desde y hacia el hotel'],
        includes_en: ['Private table (box with the best view of the stage)', 'Starter or dessert, 2 drinks of choice, water or soft drink, glass of wine or beer', 'Tango show', 'Round-trip transfer to and from the hotel'],
        price_adult_usd: 70, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:00 y 19:45 (Palermo desde 18:45)', pickup_window_en: 'Between 7:00 and 7:45 PM (Palermo from 6:45 PM)',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 55, price_child_usd: null, has_dinner: false, has_transfer: false, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: null, pickup_window_en: null,
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:15', show_time_en: 'Show from 10:15 PM',
      },
    ],
  },
  ...
  // ── Cátulo Tango ───────────────────────────────────────────
  {
    ...
    address_es: 'Abasto, Buenos Aires',
    address_en: 'Abasto, Buenos Aires',
    ...
    options: [
      {
        ...
        price_adult_usd: 96, price_child_usd: 48, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:15', pickup_window_en: 'Between 7:30 and 8:15 PM',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        code: 'cena-show', name_es: 'Cena Show', name_en: 'Dinner Show',
        ...
        price_adult_usd: 77, price_child_usd: 38.5, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:15', pickup_window_en: 'Between 7:30 and 8:15 PM',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
        ...
        price_adult_usd: 34, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:15', pickup_window_en: 'Between 7:30 and 8:15 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
    ],
    ...
    options: [
      {
        ...
        price_adult_usd: 180, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:00 y 20:30 (Palermo 19:30 a 20:00)', pickup_window_en: 'Between 8:00 and 8:30 PM (Palermo 7:30 to 8:00 PM)',
        dinner_time_es: 'Cena desde 20:30', dinner_time_en: 'Dinner from 8:30 PM', show_time_es: 'Show desde 22:15', show_time_en: 'Show from 10:15 PM',
      },
      {
      ...
      },
      {
        ...
        price_adult_usd: 60, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 21:00 y 21:30', pickup_window_en: 'Between 9:00 and 9:30 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 22:15', show_time_en: 'Show from 10:15 PM',
      },
    ],
  },
    ...
    options: [
      {
        ...
        price_adult_usd: 190, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00', pickup_window_en: 'Between 7:30 and 8:00 PM',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
    ...
    options: [
      {
        ...
        price_adult_usd: 190, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:00 y 19:30 (Palermo 18:30)', pickup_window_en: 'Between 7:00 and 7:30 PM (Palermo 6:30 PM)',
        dinner_time_es: 'Cena desde 19:30', dinner_time_en: 'Dinner from 7:30 PM', show_time_es: 'Show desde 21:30', show_time_en: 'Show from 9:30 PM',
      },
      {
        code: 'cena-show', name_es: 'Cena Show', name_en: 'Dinner Show',
        description_es: null, description_en: null,
        ...
        includes_en: ['Private table', '3-course à la carte menu: starter, main course and dessert', 'Free drinks: wine, beer, soft drinks and mineral water', 'Tango show', 'Round-trip transfer from hotels'],
        price_adult_usd: 150, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:00 y 19:30', pickup_window_en: 'Between 7:00 and 7:30 PM',
        dinner_time_es: 'Cena desde 19:30', dinner_time_en: 'Dinner from 7:30 PM', show_time_es: 'Show desde 21:30', show_time_en: 'Show from 9:30 PM',
      },
      {
        code: 'solo-show-vip', name_es: 'Solo Show VIP', name_en: 'Show Only VIP',
        ...
        price_adult_usd: 120, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:45 y 21:15', pickup_window_en: 'Between 8:45 and 9:15 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 21:30', show_time_en: 'Show from 9:30 PM',
      },
      {
        code: 'solo-show', name_es: 'Solo Show', name_en: 'Show Only',
        description_es: null, description_en: null,
        ...
        price_adult_usd: 80, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 20:45 y 21:15', pickup_window_en: 'Between 8:45 and 9:15 PM',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 21:30', show_time_en: 'Show from 9:30 PM',
      },
    ],
    ...
    options: [
      {
        ...
        price_adult_usd: 170, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Entre 19:30 y 20:00 (Palermo desde 19:00)', pickup_window_en: 'Between 7:30 and 8:00 PM (Palermo from 7:00 PM)',
        dinner_time_es: 'Cena desde 20:00', dinner_time_en: 'Dinner from 8:00 PM', show_time_es: 'Show desde 22:00', show_time_en: 'Show from 10:00 PM',
      },
      {
  ...
  // ── Rojo Tango ─────────────────────────────────────────────
  {
    ...
    address_es: 'Hotel Faena, Puerto Madero, Buenos Aires',
    address_en: 'Hotel Faena, Puerto Madero, Buenos Aires',
    ...
    options: [
      {
        ...
        price_adult_usd: 290, price_child_usd: null, has_dinner: true, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Desde zona centro o Palermo', pickup_window_en: 'From downtown or Palermo',
        dinner_time_es: 'Cena desde 19:30', dinner_time_en: 'Dinner from 7:30 PM', show_time_es: 'Show desde 21:15', show_time_en: 'Show from 9:15 PM',
      },
      {
        code: 'solo-show', name_es: 'Solo Show', name_en: 'Show Only',
        description_es: null, description_en: null,
        ...
        price_adult_usd: 220, price_child_usd: null, has_dinner: false, has_transfer: true, available_days: [1, 2, 3, 4, 5, 6, 7],
        pickup_window_es: 'Desde zona centro o Palermo', pickup_window_en: 'From downtown or Palermo',
        dinner_time_es: null, dinner_time_en: null, show_time_es: 'Show desde 21:15', show_time_en: 'Show from 9:15 PM',
      },
    ],
  },
];
        ...
        await client.query(
          `INSERT INTO product_options (
           ...
           ON CONFLICT (product_id, code) DO UPDATE SET
             ...
             dinner_time_es = EXCLUDED.dinner_time_es,
             dinner_time_en = EXCLUDED.dinner_time_en,
             show_time_es = EXCLUDED.show_time_es,
             show_time_en = EXCLUDED.show_time_en,
