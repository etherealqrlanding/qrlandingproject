...
const ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a_es: 'Es una plataforma exclusiva para clientes recomendados por nuestra red de recomendadores autorizados (hoteles, guías, choferes, agencias). El link o QR que te compartieron te da acceso a precios oficiales con la garantía de Tango QR. Si lo perdiste, pedile a esa persona que te lo reenvíe.',
    a_en: 'This is an exclusive platform for guests referred by our network of authorized sellers (hotels, guides, drivers, agencies). The link or QR code you were given grants access to official prices backed by Tango QR. If you lost it, ask that person to resend it to you.',
  },
  {
